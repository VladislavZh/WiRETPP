...
from wishart_tpp.training.state import PureCheckpoint
...
def pure_checkpoint_payload(checkpoint: PureCheckpoint) -> dict[str, Any]:
    """Serialize a Pure checkpoint without runtime objects."""
...
def pure_checkpoint_from_payload(payload: dict[str, Any]) -> PureCheckpoint:
    """Restore a Pure checkpoint from its serialized fields."""
